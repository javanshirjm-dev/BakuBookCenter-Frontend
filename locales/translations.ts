...
export const translations = {
    en: {
        ...
        news: {
            ...
            loadingDetail: "Loading story…",
            sectionLabel: "Latest Stories",
            pageTitle1: "News &",
            watermark: "News.",
            pageTitle2: "Announcements.",
            pageDesc: "Stories from our shelves, new arrivals, reading guides, and everything happening at Baku Book Center.",
            publishedCount: (n: number) => `${n} article${n === 1 ? '' : 's'} published`,
            allStoriesLabel: "All Stories",
            readMore: "Read More →",
            noStoriesTitle: "No stories yet.",
            noStoriesDesc: "Check back soon — we have plenty to share.",
            notFoundTitle: "Story not found.",
            notFoundDesc: "This article may have moved or been removed.",
            backToNews: "← Back to News",
            breadcrumbNews: "News",
            fullStory: "Full Story",
            published: "Published",
            source: "Source",
            bakuBookCenter: "Baku Book Center",
            storyDesc: "Stay updated with our latest announcements and stories from the shelves.",
            photosLabel: "Photos",
        ...
        orders: {
            ...
            orderCount: (n: number) => `${n} order${n !== 1 ? 's' : ''} placed`,
            successMessage: "Order placed successfully!",
            successDetail: (email: string) => `A confirmation email has been sent to ${email}.`,
            loadingOrders: "Fetching your orders…",
            noOrdersTitle: "No orders yet.",
            noOrdersDesc: "Your next favourite book is waiting for you.",
            browseShop: "Browse the Shop",
            orderTableHeaders: ["Order", "Items", "Date", "Total", "Status", ""],
            deliveryAddress: "Delivery Address",
            recipient: "Recipient",
            payment: "Payment",
    ...
    az: {
        ...
        news: {
            ...
            loadingDetail: "Xəbər yüklənir…",
            sectionLabel: "Ən Yeni Hekayələr",
            pageTitle1: "Xəbərlər &",
            pageTitle2: "Elanlar.",
            pageDesc: "Rəflərimizdən hekayələr, yeni gələnlər, oxu bələdçiləri və Baku Book Center-də baş verən hər şey.",
            publishedCount: (n: number) => `${n} məqalə dərc edilmişdir`,
            allStoriesLabel: "Bütün Hekayələr",
            watermark: "Elanlar.",
            readMore: "Daha Oxu →",
            noStoriesTitle: "Hələ xəbər yoxdur.",
            noStoriesDesc: "Tezliklə geri dönün — paylaşacağımız çoxlu şey var.",
            notFoundTitle: "Xəbər tapılmadı.",
            notFoundDesc: "Bu məqalə köçürülmüş və ya silinmiş ola bilər.",
            backToNews: "← Xəbərlərə Qayıt",
            breadcrumbNews: "Xəbərlər",
            fullStory: "Tam Hekayə",
            published: "Dərc edildi",
            source: "Mənbə",
            bakuBookCenter: "Baku Book Center",
            storyDesc: "Ən son elanlarımız və rəflərimizdən hekayələr haqında xəbərdar olun.",
            photosLabel: "Şəkillər",
            photos: (n: number) => `${n} şəkil`,
            backToAllNews: "← Bütün Xəbərlərə Qayıt",
        },
        // Header:
        header: {
            catalog: "Kataloq",
        ...
        // Orders Page:
        orders: {
            pageTitle: "Sizin Sifarişləriniz",
            sectionLabel: "Hesabım",
            watermark: "Sifarişlər.",
            orderCount: (n: number) => `${n} sifariş verilmişdir`,
            successMessage: "Sifariş uğurla yerləşdirildi!",
            successDetail: (email: string) => `Təsdiq e-postu ${email} ünvanına göndərildi.`,
            loadingOrders: "Sifarişləriniz yüklənir…",
            noOrdersTitle: "Hələ sifariş yoxdur.",
            noOrdersDesc: "Sizin növbəti sevdiyiniz kitab sizi gözləyir.",
            browseShop: "Mağazaya Baxın",
            orderTableHeaders: ["Sifariş", "Məişətlər", "Tarix", "Cəm", "Vəziyyət", ""],
            deliveryAddress: "Çatdırılış Ünvanı",
            recipient: "Alıcı",
            payment: "Ödəniş",
            cardEnding: "Kart sonu",
            itemsInOrder: "Bu Sifarişdəki Məişətlər",
            quantity: "Miq",
            orderTotal: "Sifariş Cəmi",
            continueShopping: "Alış-verişə Dəvam Et →",
            lastFourDigits: "••••",
        },
    },
    ...
    ru: {
        ...
        news: {
            ...
            loadingDetail: "Загрузка истории…",
            sectionLabel: "Последние истории",
            pageTitle1: "Новости И",
            pageTitle2: "Объявления.",
            pageDesc: "Истории с наших полок, новые поступления, руководства по чтению и все, что происходит в Baku Book Center.",
            publishedCount: (n: number) => `${n} статья опубликована${n === 1 ? '' : 'ны'}`,
            allStoriesLabel: "Все истории",
            readMore: "Читать далее →",
            watermark: "Истории.",
            noStoriesTitle: "Пока нет историй.",
            noStoriesDesc: "Проверьте позже — у нас есть, чем поделиться.",
            notFoundTitle: "История не найдена.",
            notFoundDesc: "Эта статья могла быть перемещена или удалена.",
            ...
            source: "Источник",
            bakuBookCenter: "Baku Book Center",
            storyDesc: "Будьте в курсе последних объявлений и историй с наших полок.",
            photosLabel: "Фотографии",
            photos: (n: number) => `${n} фото${n === 1 ? '' : 'графия'}`,
            backToAllNews: "← Назад ко всем новостям",
        },
        // Header:
        header: {
            catalog: "Каталог",
        ...
        orders: {
            ...
            sectionLabel: "Мой аккаунт",
            watermark: "Заказы.",
            orderCount: (n: number) => `${n} заказ${n === 1 ? '' : n < 5 ? 'а' : 'ов'} размещено`,
            successMessage: "Заказ успешно размещен!",
            successDetail: (email: string) => `Письмо с подтверждением отправлено на ${email}.`,
            loadingOrders: "Загрузка ваших заказов…",
            noOrdersTitle: "У вас еще нет заказов.",
            noOrdersDesc: "Ваша следующая любимая книга ждет вас.",
            browseShop: "Перейти в магазин",
            orderTableHeaders: ["Заказ", "Товары", "Дата", "Итого", "Статус", ""],
            deliveryAddress: "Адрес доставки",
            recipient: "Получатель",
            payment: "Платеж",
            cardEnding: "Карта заканчивается на",
            itemsInOrder: "Товары в этом заказе",
            quantity: "Кол",
