...
export default function ResetPasswordPage() {
    ...
    // Get token from URL - can be either from /reset-password/[token] or /reset-password?token=[token]
    const token = searchParams?.get('token') || (params?.token ? (Array.isArray(params.token) ? params.token[0] : params.token) : '');
